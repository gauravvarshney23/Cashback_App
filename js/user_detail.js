		  ...
		  {	
			...
			if((localStorage.userID!=null) || (localStorage.userID))
					...
					'</div>';
				    	 ...
				    	 {
				    	newlead_div1_data='<div onclick="main()" class="row" style="background-color:#4169e1;">'+
					                      '<div class="col-xs-5" style="padding-top:2%">'+
						                   '<a href="">'+
							     '<img src="img/menu-user.png" class="img-circle" style="width:60px;height:60px;">'+
						       '</a>'+
					'</div>'+
					'<div class="col-xs-6" style="padding:5% 0% 0% 0%">'+
						'<a href="">'+
